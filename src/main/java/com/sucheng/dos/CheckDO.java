...
public class CheckDO extends BaseDO {
    ...
    private static final long serialVersionUID = -9223372035628724740L;
	...
	*/
    ...
    public CheckDO (Integer id, String checkNo, Integer rawId, Float stockCount, Float realCount, Float gapCount, String checkEmp, Date checkTime, String status, String descript) {
        this.id = id;
