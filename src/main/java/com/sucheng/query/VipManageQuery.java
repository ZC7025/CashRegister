 ...
 * @version 1.0
 */
public class VipManageQuery extends BaseQuery {

    private static final long serialVersionUID = -9223372036215551686L;
	...
	*/
    ...
    public VipManageQuery () {}

    public VipManageQuery (Integer id, Date vipDay, String discountWay, Float discount, Integer integral, Integer defaultIntegral, Integer storeId, String status, Date createdTime) {
        this.id = id;
		this.vipDay = vipDay;
