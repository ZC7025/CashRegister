 ...
 * @version 1.0
 */
public class CheckQuery extends BaseQuery {

    private static final long serialVersionUID = -9223372035354785162L;
	...
	*/
    ...
    public CheckQuery (Integer id, String checkNo, Integer rawId, Float stockCount, Float realCount, Float gapCount, String checkEmp, Date checkTime, String status, String descript) {
        this.id = id;
