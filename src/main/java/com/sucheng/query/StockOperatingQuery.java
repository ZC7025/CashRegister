 ...
 * @version 1.0
 */
public class StockOperatingQuery extends BaseQuery {

    private static final long serialVersionUID = -9223372035530939456L;
	...
	*/
    ...
    public StockOperatingQuery (Integer id, Integer rawId, Float inStockCount, Float outStockCount, String unit, String empName, Date operatingTime, String descript) {
        this.id = id;
		this.rawId = rawId;
