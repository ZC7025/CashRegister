...
public class ProductQuery extends BaseQuery {
    ...
    private static final long serialVersionUID = -9223372034789617387L;
	...
	*/
    ...
    public ProductQuery (Integer id, String name, Integer storeId, Integer tasteId, BigDecimal price, String proImg1, String proImg2, String proImg3, String proImg4, Integer priority, String status, Date createdTime) {
        this.id = id;
		this.name = name;
