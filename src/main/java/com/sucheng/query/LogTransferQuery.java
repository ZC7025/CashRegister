 ...
 * @version 1.0
 */
public class LogTransferQuery extends BaseQuery {

    private static final long serialVersionUID = -9223372035443780898L;
	...
	*/
    ...
    public LogTransferQuery () {}

    public LogTransferQuery (Integer id, Date startTime, Date endTime, Integer empId, Integer storeId, BigDecimal cashCount, BigDecimal cashPay, BigDecimal wechatPay, BigDecimal aliPay, BigDecimal bankcardPay, BigDecimal vipCardPay, BigDecimal aidCardPay, BigDecimal otherPay, BigDecimal cashRemaining) {
        this.id = id;
