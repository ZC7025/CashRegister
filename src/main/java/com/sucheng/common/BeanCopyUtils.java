            ...
            if (PropertyUtils.isReadable(orig, name)
                ...
                try {
                    ...
                    try {
                        ...
                        Object newValue = targetDescriptor.getPropertyType()
                                .newInstance();
                        copy(newValue, value);
//                      LOG.info(newValue);
                    ...
                    catch (IllegalAccessException | InvocationTargetException | NoSuchMethodException | InstantiationException e1) {
                        throw e1;
                    }
