 ...
 * @version 1.0
 */
public class LogTransferDTO extends BaseDTO {

    private static final long serialVersionUID = -9223372035048138646L;
	...
	*/
    ...
    public LogTransferDTO () {}

    public LogTransferDTO (Integer id, Date startTime, Date endTime, Integer empId, Integer storeId, BigDecimal cashCount, BigDecimal cashPay, BigDecimal wechatPay, BigDecimal aliPay, BigDecimal bankcardPay, BigDecimal vipCardPay, BigDecimal aidCardPay, BigDecimal otherPay, BigDecimal cashRemaining) {
        this.id = id;
