...
public class OrdersDTO extends BaseDTO {
    ...
    private static final long serialVersionUID = -9223372036692692181L;
	...
	*/
    ...
    public OrdersDTO (Integer id, Integer storeId, Integer supplieId, String listName, String status, Date orderTime) {
        this.id = id;
