...
public class CheckDTO extends BaseDTO {
    ...
    private static final long serialVersionUID = -9223372035093337852L;
	...
	*/
    ...
    public CheckDTO (Integer id, String checkNo, Integer rawId, Float stockCount, Float realCount, Float gapCount, String checkEmp, Date checkTime, String status, String descript) {
        this.id = id;
