 ...
 * @version 1.0
 */
public class VipManageVO extends BaseVO {

    private static final long serialVersionUID = -9223372036596011465L;
	...
	*/
    ...
    public VipManageVO (Integer id, Date vipDay, String discountWay, Float discount, Integer integral, Integer defaultIntegral, Integer storeId, String status, Date createdTime) {
        this.id = id;
		this.vipDay = vipDay;
