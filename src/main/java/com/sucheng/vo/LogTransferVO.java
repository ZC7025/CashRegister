 ...
 * @version 1.0
 */
public class LogTransferVO extends BaseVO {

    private static final long serialVersionUID = -9223372036485324503L;
	...
	*/
    ...
    public LogTransferVO () {}

    public LogTransferVO (Integer id, Date startTime, Date endTime, Integer empId, Integer storeId, BigDecimal cashCount, BigDecimal cashPay, BigDecimal wechatPay, BigDecimal aliPay, BigDecimal bankcardPay, BigDecimal vipCardPay, BigDecimal aidCardPay, BigDecimal otherPay, BigDecimal cashRemaining) {
        this.id = id;
